        ...
        <div id="orderFormAdd">
                ...
                <tr>
                    ...
                    <td style="width:32%;">
                        <input name="businessId" id="businessId" class="mini-combobox" style="width:200px; "
                               ...
                               required="true" valueFromSelect="true" maxlength="15" requiredErrorText="业务类型不能为空"
                                 allowInput="true"/>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width:32%;">
                        <input name="customerId" id="customerId" class="mini-combobox" style="width:200px;"  required="true" maxlength="50"
                             ...
                             allowput="true" valueFromSelect="true"  idField="id" textField="customerName" url="${pageContext.request.contextPath}/customer/queryCustomerList" />
                    </td>
            ...
            <div id="orderItemGrid" class="mini-datagrid" style="width:100%;height:215px;"
                ...
                <div property="columns">
                    ...
                    <div field="materialNum" name="materialNum"  headerAlign="center" width="130" allowSort="true" >原厂料号
                    ...
                    <div field="price" headerAlign="center" width="90" allowSort="true" >采购单价
