...
<div class="mini-layout" style="width: 100%;height: 100%;" allowResize="false">
    <div title="north" region="north" showSplit="false" showSplitIcon="false" height="105px" showHeader="false"
         style="border: none">
            ...
            <div style="margin-left: 2%;display:inline;line-height: 32px;" class="searchBar" id="orderForm">
                <div style="width: 940px;margin: 0 auto">
                    ...
                    <div>
                        ...
                        <input name="ycmaterialNum" id="ycmaterialNum" class="mini-textbox" emptyText="原厂料号"  style="width:120px;"/>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:30%;">
                        ...
                        <a  class="mini-button block-button hide" iconCls="icon-redo" id="export" onclick="PageOrder.funExport2()">导出出货单</a>
                    </td>
                </tr>
            </table>
        </div>
