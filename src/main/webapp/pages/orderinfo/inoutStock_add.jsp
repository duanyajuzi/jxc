...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/pages/orderinfo/js/inoutStock_add.js'/>"></script>
    <title></title>
    <style>
...
<div class="mini-layout" style="width: 100%;height: 100%;" allowResize="false">
        ...
        <div id="InoutStockFormAdd">
            ...
            <table class="form-table" border="0" cellpadding="1" cellspacing="2" style="width:100%;table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td style="width:32%;">
                        <input name="isBIll" id="isBIll" class="mini-combobox" style="width:200px;" required="true" maxlength="19" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div  region="south" showSplit="false" showSplitIcon="false" height="30" showHeader="false"  style="border: none">
        <div class="mini-toolbar" style="position: fixed;left:0;bottom: 0;right:0;text-align: center;border-width: 1px 0 0 0" >
            <a class="mini-button cursor" onclick="PageInoutStockAdd.funSave()" iconCls="icon-save">保存</a>
            <a class="mini-button cursor" onclick="PageInoutStockAdd.funCancel()" iconCls="icon-cancel" style="margin:0 20px;">取消</a>
        </div>
    </div>
</div>
