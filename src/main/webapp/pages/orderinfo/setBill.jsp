...
<div class="mini-layout" style="width: 100%;height: 100%;" allowResize="false">
    <div region="west" showSplit="false" showSplitIcon="false" width="650"  showHeader="false"
        ...
        <div id="p1" class="mini-panel" title="检索条件" style="width: 100%;"
            ...
            <div style="margin-left: 2%;display:inline;line-height: 32px;" class="searchBar" id="searchForm">
                ...
                <a class="mini-button" iconCls="icon-search" style="height: auto" onclick="PageSetBill.funSearch()" plain="true"></a>
            </div>
        </div>
        <div id="inoutGrid" class="mini-datagrid" sortMode="client" style="height: 480px"
            ...
            <div property="columns">
                ...
                <div field="pcustomerName" name="pcustomerName"  width="100" headerAlign="center" allowSort="true">采购公司</div>
                <div field="pcontacts" width="80"  visible="false" headerAlign="center" allowSort="true">联系人</div>
                <div field="paddress" width="120"  visible="false" headerAlign="center" allowSort="true">地址</div>
                <div field="ptel" width="100"  visible="false" headerAlign="center" allowSort="true">电话</div>
                <%--入库开票--%>
                <%--<div field="customerId"  visible="false">customerId</div>--%>
                <%--<div field="customerName"  width="100" headerAlign="center" allowSort="true">厂商</div>--%>
                <%--<div field="contacts" width="80"  visible="false" headerAlign="center" allowSort="true">联系人</div>--%>
                <%--<div field="address" width="120"  visible="false" headerAlign="center" allowSort="true">地址</div>--%>
                <%--<div field="tel" width="100"  visible="false" headerAlign="center" allowSort="true">电话</div>--%>
            </div>
        </div>
    ...
    width="430" style="border:1px solid #cccccc;">
        <div id="detailGrid" class="mini-datagrid" idField="id"  sortMode="client" style="height: 420px"
             ...
             allowCellEdit="true" allowCellSelect="true" editNextOnEnterKey="true"  editNextRowCell="true" navEditMode="true">
                <div property="columns">
                    ...
                    <div field="pcontacts" visible="false"width="80" headerAlign="center" allowSort="true">联系人
                        <input property="editor" class="mini-textbox" style="width:100%;"/></div>
                    <div field="paddress"visible="false" width="120"  headerAlign="center" allowSort="true">地址
                        <input property="editor" class="mini-textbox" style="width:100%;"/></div>
                    <div field="ptel" visible="false" width="100"  headerAlign="center" allowSort="true">电话
                        <input property="editor" class="mini-textbox" style="width:100%;"/></div>
                    ...
                    <div field="action" width="40" headerAlign="center" allowSort="true">操作</div>
                </div>
            </div>
        ...
        <div id="billAddForm">
            ...
            <table class="form-table" border="0" cellpadding="2" cellspacing="3" style="width:100%;table-layout:fixed;">
                <tr>
                    <td class="form-label" id="tdCustomer" style="text-align: right;width:16%;">采购公司：</td>
                    <td style="width:32%;">
                    ...
                    <td class="form-label" style="text-align: right;width:20%;">联系人：</td>
                    <td style="width:32%;">
                        <input name="contacts" id="contacts" class="mini-textbox"  required="true" style="width:125px;"/>
                    </td>
                </tr>
                <tr>
                    <td class="form-label" style="text-align: right;width:16%;">地址：</td>
                    <td style="width:16%;">
                        <input name="address" id="address" class="mini-textbox" required="true" style="width:125px;"/>
                    </td>
                    <td class="form-label" style="text-align: right;width:20%;">联系方式：</td>
                    <td style="width:16%;">
                        <input name="tel" id="tel" class="mini-textbox"  required="true"  style="width:125px;"/>
                    </td>
                </tr>
                <tr>
