...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/pages/sysinfo/js/role_add.js'/>"></script>
    <title></title>
    <style>
...
<div class="mini-layout" style="width: 100%;height: 100%;" allowResize="false">
        ...
        <div id="roleFormAdd">
            ...
            <table class="form-table" border="0" cellpadding="1" cellspacing="2" style="width:100%;table-layout:fixed;">
                <tr>
                    <td class="form-label" style="text-align: right;width:16%;">角色名称：</td>
                    <td style="width:32%;">
                        <input name="roleName" id="roleName" class="mini-textbox" style="width:200px;"  required="true" maxlength="50" requiredErrorText="角色名称不能为空"/>
                    </td>
                </tr>
                <tr>
        ...
        <div  region="south" showSplit="false" showSplitIcon="false" height="30" showHeader="false"  style="border: none">
	        <div class="mini-toolbar" style="position: fixed;left:0;bottom: 0;right:0;text-align: center;border-width: 1px 0 0 0" >
	            <a class="mini-button cursor" onclick="PageRoleAdd.funSave()" iconCls="icon-save">保存</a>
	            <a class="mini-button cursor" onclick="PageRoleAdd.funCancel()" iconCls="icon-cancel" style="margin:0 20px;">取消</a>
	        </div>
        </div>
    </div>
